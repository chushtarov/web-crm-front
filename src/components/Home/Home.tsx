        ...
        <div className={style.home_content}>
          <div className={style.home_about}>
            <div className={style.home_promotion}>
              <p className={style.home__well}>
                Курс «Фронтенд-разработчик» с нуля до трудоустройства{" "}
                <span className={style.home_span}>за 4 месяцев</span>
              </p>
            ...
            <h1 className={style.home_frontend}>
              «Фронтенд- <br />
              разработчик»
            </h1>
            <p className={style.home_info}>
              Научитесь программировать на языке JavaScript и создавать <br />
          ...
          <div className={style.home_img}>
            <p className={style.home_img_content}>
              Трудоустроим <br /> или вернем деньги
            </p>
